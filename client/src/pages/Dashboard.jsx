...
const Dashboard = () => {
  ...
  return (
    <section className='dashboard' style={{ minHeight: '50vh' }}>
      <div style={{ width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: '37px', padding: '20px', fontWeight: '600' }}>Dashboard</div>
      {
